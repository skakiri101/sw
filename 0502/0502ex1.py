...
print('-5의 절대값:',num1)
print('4,6의 반올림값:',num1)
print('정수10의 이진수값:',num2)
...
print('num10 원소중 가장 큰 값:',max(num10))
print('num10 원소중 가장 작은 값:',min(num10))
